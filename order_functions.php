...
function order(): string {
    ...
    $_SESSION['dessert'] = ($dessert !== '' && $dessert !== 'none') ? $dessert : '(not selected)';
    $_SESSION['drink'] = ($drink !== '' && $drink !== 'none') ? $drink : '(not selected)';
    $_SESSION['drinkSize'] = ($drinkSize !== '') ? $drinkSize : '(not selected)';

    return "Dessert: " . htmlspecialchars($_SESSION['dessert']) . "<br>"
        . "Drink: " . htmlspecialchars($_SESSION['drink']) . "<br>"
        . "Drink size: " . htmlspecialchars($_SESSION['drinkSize']);
}
